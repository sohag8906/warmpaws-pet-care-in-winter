  ...
  const vets = [
    {
      ...
      image: "https://i.ibb.co/MxZBTktJ/images-2.jpg"
    },
    {
      id: 2,
      name: "Dr. David Miller",
      experience: "5 years experience in grooming & coat health",
      email: "david.miller@petcare.com",
      image: "https://i.ibb.co/pBd97fMr/images-3.jpg"
    },
    {
      id: 3,
      name: "Dr. Emma Brown",
      experience: "10 years experience in pet wellness & cold protection",
      email: "emma.brown@petcare.com",
      image: "https://i.ibb.co/W4XHt7SM/images-4.jpg"
    },
    {
      id: 4,
      name: "Dr. Alex Carter",
      experience: "6 years experience in animal therapy and cold injury prevention",
      email: "alex.carter@petcare.com",
      image: "https://i.ibb.co/Qvnt9S9F/download-7.jpg"
    }
  ];
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {vets.map((vet) => (
          ...
          >
            ...
            <p className="text-blue-500 mt-1">{vet.email}</p>
          </div>
        ))}
      </div>
    </div>
