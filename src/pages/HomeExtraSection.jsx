...
const HomeExtraSection = () => {
    return (
        <div className="container mx-auto px-4 py-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg mt-10">
            <h2 className="text-3xl font-bold mb-3 text-center text-indigo-700">
                Winter Pet Games
            </h2>
            <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
         Keep your pets active and happy indoors with fun and engaging winter games they’ll absolutely love.
        </p>
